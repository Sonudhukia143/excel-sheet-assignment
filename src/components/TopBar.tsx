	...
	return (
		<div className="flex items-center justify-between bg-white h-[56px] px-4 py-2 border-b border-[#E0E0E0]">
			...
			<div className="flex items-center gap-4">
				{/* Search */}
				<div className="relative cursor-pointer" onClick={() => console.log('Search icon clicked')}>
					<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M17.5 17.5L12.5 12.5M14.1667 8.33333C14.1667 11.555 11.555 14.1667 8.33333 14.1667C5.11167 14.1667 2.5 11.555 2.5 8.33333C2.5 5.11167 5.11167 2.5 8.33333 2.5C11.555 2.5 14.1667 5.11167 14.1667 8.33333Z" stroke="#121212" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
					</svg>
				</div>
				...
				<div className="flex items-center gap-2 pl-2 pr-3 py-[6px] ">
					...
					<div className="flex flex-col max-h-8">
						<span className="text-sm font-normal truncate">User</span>
